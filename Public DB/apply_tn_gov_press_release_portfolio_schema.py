"""Add portfolio flag column to tn_gov_press_releases."""
...
alter table public.tn_gov_press_releases
    add column if not exists portfolio boolean not null default false;
...
def main() -> int:
    ...
    print("tn_gov_press_releases portfolio column ready.")
    return 0
