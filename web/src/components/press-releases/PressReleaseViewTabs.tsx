...
type PressReleaseViewTabsProps = {
  view: PressReleaseView;
  onViewChange: (view: PressReleaseView) => void;
  className?: string;
};

const VIEW_OPTIONS: PressReleaseView[] = ["all", "department", "minister"];
    ...
    >
      {VIEW_OPTIONS.map((option, index) => {
        ...
        return (
          ...
          >
            {PRESS_RELEASE_VIEW_LABELS[option]}
          </button>
        );
      })}
    </div>
